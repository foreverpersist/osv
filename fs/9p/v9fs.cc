 ...
 * 2000, 2000.u读取属性信息填充vnode
 * type即文件类型,取st->mode的15-12位,通过IFTOVT映射为OSv类型
 * mode即文件权限, 取st->mode的11-0位
 * [Debug] p9_wstat如何解析出type, mode
 */
 ...
 * 2000.L读取属性信息填充vnode
 * [Debug] p9_wstat_dotl如何解析出type, mode
 */
 ...
 * 2000, 2000.u将flags转换为p9的mode bits
 */
